...
ClientScript::getInstance()->registerCssFile(\Dict\Components\Pub::getAssetBaseUrl() . '/css/error.css');
?>
<div id="error-box">
    ...
    <div id="error-content">
        ...
        <div id="error-right" class="text-warning">
            ...
            <ul id="error-links">
                <li><a href="<?php echo $this->createUrl('//dict'); ?>">Home</a></li>
...
<script type="text/javascript">
    var timer = window.setInterval(function () {
        ...
        if (0 === second) {
            ...
            window.location.href = '<?php echo $this->createUrl('//dict'); ?>';
        }
    }, 1000);
</script>
